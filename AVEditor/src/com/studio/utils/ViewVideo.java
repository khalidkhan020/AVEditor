...
public class ViewVideo extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		else
		{
			...
			Intent trimIntent = getIntent();
			videoPlayerState.setFilename(trimIntent.getStringExtra("trimfile"));
		}
	...
	private OnClickListener trimClickListener()
	{
		return new OnClickListener()
		{
			...
			public void onClick(View arg0)
			{
				...
				// intent.putExtra("messenger", new
				// Messenger(completionHander));
	...
	{
		return new Intent(ViewVideo.this, MainActivity.class);
	}
